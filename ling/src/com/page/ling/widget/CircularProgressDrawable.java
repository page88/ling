...
public class CircularProgressDrawable extends Drawable {
    ...
    /**
     * Color for the completed ringbg
     */
     ...
     */
    CircularProgressDrawable(int ringWidth, float circleScale, int outlineColor, int ringColor, int ringbgColor, int centerColor) {
        this.progress = 0;
        ...
        //this.paint.setTypeface(Typeface.createFromAsset(SoftApplication.softApplication.getAssets(),"simhei.ttf"));
    ...
    public void draw(Canvas canvas) {
        ...
        int progressValue = (int) (getProgress() * 100); 
        ...
        paint.getTextBounds(strProgress, 0, strProgress.length(), txtbounds);
        canvas.drawText(strProgress, bounds.centerX(), bounds.centerY()+txtbounds.height()/2, paint);
        paint.setTextAlign(Paint.Align.LEFT);
        paint.setTextSize(40.0f);
        int x = bounds.centerX() + txtbounds.width()/2;
        int y = bounds.centerY() - txtbounds.height()/2;
        paint.getTextBounds("%", 0, "%".length(), txtbounds);
        canvas.drawText("%", x + 2, y+txtbounds.height(), paint);
...
//        canvas.drawCircle(bounds.centerX(), bounds.centerY(), innerRadius, paint);
        ...
        canvas.drawCircle(bounds.centerX(), bounds.centerY(), Math.min(arcElements.width()/2, arcElements.height()/2), paint);
        ...
        //paint.setPathEffect(new DashPathEffect(new float[]{0.1f, 20}, 0));
    ...
    public static class Builder {
        ...
        public Builder setRingbgColor(int ringbgColor){
        	this.ringbgColor = ringbgColor;
        	return this;
        }
        ...
        public CircularProgressDrawable create() {
            return new CircularProgressDrawable(ringWidth, circleScale, outlineColor, ringColor, ringbgColor, centerColor);
        }
